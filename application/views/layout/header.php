                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="<?= base_url('assets/') ?>index.html">Dashboard 1</a>
                                </li>
                                <li>
                                    <a href="<?= base_url('assets/') ?>index2.html">Dashboard 2</a>
                                </li>
                                <li>
                                    <a href="<?= base_url('assets/') ?>index3.html">Dashboard 3</a>
                                </li>
                                <li>
                                    <a href="<?= base_url('assets/') ?>index4.html">Dashboard 4</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="<?= base_url('assets/') ?>chart.html">
                                <i class="fas fa-chart-bar"></i>Charts</a>
                        </li>
                        <li>
                            <a href="<?= base_url('assets/') ?>table.html">
                                <i class="fas fa-table"></i>Tables</a>
                        </li>
                        <li>
                            <a href="<?= base_url('assets/') ?>form.html">
                        ...
                        <li>
                            <a href="<?= base_url('assets/') ?>map.html">
                        ...
                        if ($user['role'] == 'Admin') { ?>
                            <li>
                                <a href="<?= site_url('Mahasiswa/') ?>">
                                    <i class="fas fa-table"></i>Mahasiswa</a>
                            </li>
                            <li>
                                <a href="<?= site_url('Prodi/') ?>">
                                    <i class="fas fa-table"></i>Prodi</a>
                            </li>
                            <li>
                                ...
                                <div class="noti-wrap">
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?= base_url('assets/') ?>images/icon/avatar-04.jpg"
                                                        alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Diane Myers</h6>
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?= base_url('assets/') ?>images/icon/avatar-05.jpg"
                                                        alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="<?= base_url('assets/images/profile/') . $user['gambar'] ?>"
                                                alt="" style="width: 45px;" class="img-profile rounded-circle">
                                        </div>
                                        <div class="content">
